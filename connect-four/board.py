...
class Board:
    ...
    def __init__(self, board=None, turn=None, prev_move=-1):
        ...
        self.value = self.preliminary_evaluation()
    ...
    def evaluate(self) -> int:
        ...
        self.value += self._count_threats(self.x_threats, POSITIVE)
        self.value += self._count_threats(self.o_threats, NEGATIVE)
        self.value += self._check_threats_immediacy(self.x_threats, POSITIVE)
        self.value += self._check_threats_immediacy(self.o_threats, NEGATIVE)
        # self.value += self._check_threats_parity(self.x_threats, ODD, POSITIVE)
        # self.value += self._check_threats_parity(self.o_threats, EVEN, POSITIVE)
        self.value += self._check_threats_parity2()
